  ...
  (function(root, factory) {
    ...
    upndown = (function() {
      ...
      function upndown() {
        ...
        this.methods = {};
        this.methods['_text'] = function(node) {
          var prefix, text;
        ...
        this.methods['open'] = {};
        this.methods['open']['_html'] = function(node) {
          var htmltag, i, tag;
        ...
        this.methods['open']['p'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['br'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['blockquote'] = function(node) {
          return _this.standardmethods.open._default(node, '> ');
        };
        this.methods['open']['pre'] = function(node) {
          return _this.standardmethods.open._default(node, _this.tabindent);
        };
        this.methods['open']['code'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['hr'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['ul'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['ol'] = function(node) {
          _this.currentollistack.push(1);
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['li'] = function(node) {
          return _this.standardmethods.open._default(node, _this.tabindent);
        };
        this.methods['open']['h1'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['h2'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['h3'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['h4'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['h5'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['h6'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['strong'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['b'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['em'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['i'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['a'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['img'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        };
        this.methods['open']['br'] = function(node) {
          return _this.standardmethods.open._default(node, '');
        ...
        this.methods['close'] = {};
        this.methods['close']['_html'] = function(node) {
        ...
        this.methods['close']['p'] = function(node) {
        ...
        this.methods['close']['hr'] = function(node) {
          var depth, html, nl, prefix;
          depth = _this.currentdepth();
          _this.depth--;
          prefix = _this.prefixstack_pop();
        ...
        this.methods['close']['blockquote'] = function(node) {
          var depth, html, nl, prefix;
          depth = _this.currentdepth();
          _this.depth--;
          prefix = _this.prefixstack_pop();
        ...
        this.methods['close']['pre'] = function(node) {
        ...
        this.methods['close']['code'] = function(node) {
        ...
        this.methods['close']['ul'] = function(node) {
          var depth, html, nl, prefix;
          depth = _this.currentdepth();
          _this.depth--;
          prefix = _this.prefixstack_pop();
        ...
        this.methods['close']['ol'] = function(node) {
          _this.currentollistack.pop();
          return _this.methods.close.ul(node);
        };
        this.methods['close']['li'] = function(node) {
        ...
        this.methods['close']['h1'] = function(node) {
          return _this.standardmethods.close.hx(node);
        };
        this.methods['close']['h2'] = function(node) {
          return _this.standardmethods.close.hx(node);
        };
        this.methods['close']['h3'] = function(node) {
          return _this.standardmethods.close.hx(node);
        };
        this.methods['close']['h4'] = function(node) {
          return _this.standardmethods.close.hx(node);
        };
        this.methods['close']['h5'] = function(node) {
          return _this.standardmethods.close.hx(node);
        };
        this.methods['close']['h6'] = function(node) {
          return _this.standardmethods.close.hx(node);
        };
        this.methods['close']['strong'] = function(node) {
          var depth, html, prefix;
          depth = _this.currentdepth();
          _this.depth--;
          prefix = _this.prefixstack_pop();
        ...
        this.methods['close']['b'] = function(node) {
          return _this.methods.close.strong(node);
        };
        this.methods['close']['em'] = function(node) {
          var depth, html, prefix;
          depth = _this.currentdepth();
          _this.depth--;
          prefix = _this.prefixstack_pop();
        ...
        this.methods['close']['i'] = function(node) {
          return _this.methods.close.em(node);
        };
        this.methods['close']['a'] = function(node) {
        ...
        this.methods['close']['img'] = function(node) {
        ...
        this.methods['close']['br'] = function(node) {
          var depth, html, prefix;
          depth = _this.currentdepth();
          _this.depth--;
          prefix = _this.prefixstack_pop();
      ...
      upndown.prototype.convert = function(html) {
        ...
        walkDOM(dom.getElementById("hello"), function(node) {
      ...
      upndown.prototype.isPreviousSiblingInline = function(node) {
        return node && node.previousSibling && this.isInline(node.previousSibling.tagName.toLowerCase());
      };
