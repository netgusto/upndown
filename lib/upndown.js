  ...
  (function(root, factory) {
    ...
    upndown = (function() {
      ...
      upndown.prototype.setupParser = function() {
        ...
        this.inlineelements = ['_text', 'strong', 'b', 'i', 'em', 'u', 'a', 'span', 'img', 'code'];
      ...
      function upndown() {
        this.unescape = bind(this.unescape, this);
        this.lastChildNonText = bind(this.lastChildNonText, this);
        this.hasLastChildNonTextOfType = bind(this.hasLastChildNonTextOfType, this);
        this.hasLastChildOfType = bind(this.hasLastChildOfType, this);
        this.isWrappingRootNode = bind(this.isWrappingRootNode, this);
        this.isFirstNodeNonText = bind(this.isFirstNodeNonText, this);
        this.isFirstNode = bind(this.isFirstNode, this);
        this.isLastChildNonTextUntilDepth0 = bind(this.isLastChildNonTextUntilDepth0, this);
        this.isLastChildNonText = bind(this.isLastChildNonText, this);
        this.isLastChild = bind(this.isLastChild, this);
        this.isFirstChildNonTextOfParentType = bind(this.isFirstChildNonTextOfParentType, this);
        this.hasFirstChildNonTextOfType = bind(this.hasFirstChildNonTextOfType, this);
        this.isFirstChildNonText = bind(this.isFirstChildNonText, this);
        this.isFirstChild = bind(this.isFirstChild, this);
        this.firstChildNonText = bind(this.firstChildNonText, this);
        this.hasNextSiblingNonTextOfType = bind(this.hasNextSiblingNonTextOfType, this);
        this.hasPreviousSiblingNonTextOfType = bind(this.hasPreviousSiblingNonTextOfType, this);
        this.nextsiblingnontext = bind(this.nextsiblingnontext, this);
        this.isNextSiblingNonTextBlock = bind(this.isNextSiblingNonTextBlock, this);
        this.isNextSiblingNonTextInline = bind(this.isNextSiblingNonTextInline, this);
        this.isNextSiblingBlock = bind(this.isNextSiblingBlock, this);
        this.isNextSiblingInline = bind(this.isNextSiblingInline, this);
        this.previoussiblingnontext = bind(this.previoussiblingnontext, this);
        this.isPreviousSiblingNonTextBlock = bind(this.isPreviousSiblingNonTextBlock, this);
        this.isPreviousSiblingNonTextInline = bind(this.isPreviousSiblingNonTextInline, this);
        this.isPreviousSiblingBlock = bind(this.isPreviousSiblingBlock, this);
        this.isPreviousSiblingInline = bind(this.isPreviousSiblingInline, this);
        this.isNonMarkdownBlockLevelElement = bind(this.isNonMarkdownBlockLevelElement, this);
        this.isInline = bind(this.isInline, this);
        this.convert = bind(this.convert, this);
        this.escapeTextForMarkdown = bind(this.escapeTextForMarkdown, this);
        this.hasAncestorOfType = bind(this.hasAncestorOfType, this);
        this.hasParentOfType = bind(this.hasParentOfType, this);
        this.prefixstack_pop = bind(this.prefixstack_pop, this);
        this.prefixstack_push = bind(this.prefixstack_push, this);
        this.getPrefix = bind(this.getPrefix, this);
        this.parentTag = bind(this.parentTag, this);
        this.currentdepth = bind(this.currentdepth, this);
        this.setupParser = bind(this.setupParser, this);
        this.setupParser();
        ...
        this.methods['open']['div'] = (function(_this) {
          return function(node) {
            return _this.standardmethods.open._default(node, '');
          };
        })(this);
        this.methods['open']['span'] = (function(_this) {
          return function(node) {
            return _this.standardmethods.open._default(node, '');
          };
        })(this);
        ...
        this.methods['close']['div'] = (function(_this) {
          return function(node) {
            return _this.methods.close.br(node);
          };
        })(this);
        this.methods['close']['span'] = (function(_this) {
          return function(node) {
            var depth, html, prefix;
            depth = _this.currentdepth();
            _this.depth--;
      ...
      upndown.prototype.isInline = function(tag) {
        return indexOf.call(this.inlineelements, tag) >= 0;
      };

      upndown.prototype.isNonMarkdownBlockLevelElement = function(tag) {
        return indexOf.call(this.nonmarkdownblocklevelelement, tag) >= 0;
      };
